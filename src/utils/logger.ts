...
let _Runtime:any; // to circular imports logger - Runtime
let _Type:any; // to circular imports logger - Type
let _Pointer:any; // to circular imports logger - Pointer
...
Logger.development_log_level = client_type === "deno" ? LOG_LEVEL.DEFAULT : LOG_LEVEL.DEFAULT;
